...
const DefaultImageToolbar = (0, import_editor.track)(function DefaultImageToolbar2({
  children
}) {
...
function ContextualToolbarInner({
  ...
  const isCropping = (0, import_editor.useValue)("editor path", () => editor.isIn("select.crop.cropping"), [editor]);
