...
function DefaultKeyboardShortcutsDialogContent() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(TldrawUiMenuGroup, { label: "shortcuts-dialog.text-formatting", id: "text", children: [
      /* @__PURE__ */ jsx(
        TldrawUiMenuItem,
        {
          id: "text-bold",
    ...
    /* @__PURE__ */ jsxs(TldrawUiMenuGroup, { label: "shortcuts-dialog.a11y", id: "a11y", children: [
      /* @__PURE__ */ jsx(
        TldrawUiMenuItem,
        {
